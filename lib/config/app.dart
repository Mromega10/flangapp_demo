...
class Config {
  ...
  /// Generated by SiteNative 15-07-2023 02:08:14
  /// App UID: dae496ae-8039-9a41-5312-2235b9e4791a
  /// Version: https://virtual.reallab.cloud/backend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "iwe3";
  // App link
  static String appLink = "https://iwe3.blogspot.com";
  ...
  // Admin email
  static String appEmail = "iwe3official@gmail.com";
  // Template
  ...
  // Signing
  static String osSigning = "7eda637ce824233979ef37bbdaf53a588346608f4978f44720767f76debbee96";
  // Enabled android?
